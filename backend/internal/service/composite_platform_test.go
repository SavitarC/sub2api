...
func TestCompositeGroupSchedulerHasAllCanonicalPlatformBuckets(t *testing.T) {
	...
	require.ElementsMatch(t,
		[]string{PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformAntigravity, PlatformGrok, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax, PlatformOpenCodeGo, PlatformCommandCode, PlatformCline},
		platforms,
	)
}
