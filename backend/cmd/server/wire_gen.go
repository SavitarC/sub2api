...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	cnProviderBalanceCheckService := service.ProvideCNProviderBalanceCheckService(accountRepository, cnProviderBalanceService, cnProviderQuotaService, openCodeGoUsageService, configConfig)
